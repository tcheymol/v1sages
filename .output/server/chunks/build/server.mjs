import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, h, resolveComponent, mergeProps, unref, createVNode, resolveDynamicComponent, computed, withCtx, renderSlot, createBlock, openBlock, useSlots, ref, inject, createCommentVNode, toDisplayString, createTextVNode, Fragment, renderList, toRef, toHandlers, hasInjectionContext, toValue, watch, getCurrentInstance, onServerPrefetch, provide, mergeModels, useModel, isRef, nextTick, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, Suspense, createApp, useId, shallowReactive, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, useTemplateRef, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, j as parseQuery, k as klona, l as defuFn, m as defu, n as hasProtocol, o as joinURL, q as isEqual, w as withQuery, r as withTrailingSlash, t as withoutTrailingSlash, v as isScriptProtocol, x as sanitizeStatusCode, y as getContext, e as createError$1, $ as $fetch$1, z as baseURL, p as publicAssetsURL, A as createHooks, B as executeAsync, C as toRouteMatcher, D as createRouter$1 } from '../nitro/nitro.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import colors from 'tailwindcss/colors';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderSuspense, ssrRenderAttr } from 'vue/server-renderer';
import { useForwardProps, Primitive, useForwardPropsEmits, ProgressRoot, ProgressIndicator, DialogRoot, DialogContent, VisuallyHidden, DialogTitle, DialogDescription, DialogClose, DialogTrigger, DialogPortal, DialogOverlay, Slot, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose } from 'reka-ui';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BHQJ8k5D.mjs')
  }
];
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UHeader, { ui: { root: "bg-white dark:bg-yellow-300" } }, {
              left: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "width": "120px" })}"${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            src: _imports_0,
              ...
              right: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UColorModeButton, { color: "primary" }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_component_UColorModeButton, { color: "primary" })
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode(_component_UHeader, { ui: { root: "bg-white dark:bg-yellow-300" } }, {
                left: withCtx(() => [
                  createVNode(_component_NuxtLink, { to: "/" }, {
                    default: withCtx(() => [
                      createVNode("img", {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dmh4gUXT.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BqqCPOub.mjs'));
...
export { __nuxt_component_0$1 as _, useAppConfig as a, _sfc_main$k as b, _sfc_main$g as c, _sfc_main$9 as d, entry_default as default, _sfc_main$f as e, _sfc_main$e as f, getSlotChildrenText as g, _sfc_main$7 as h, tv as t, useHead as u };
